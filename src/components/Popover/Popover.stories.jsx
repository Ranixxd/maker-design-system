...
### portal: 스크롤되는 목록 안에서 열 때 (2026-09-18)

기본 패널은 트리거 옆에 붙어 그려진다. 그래서 트리거가 스크롤되는 목록 안에 있으면 패널이
목록 틀에 잘리거나 옆 줄 아래로 깔린다. \`portal\`을 켜면 패널을 body로 옮겨 화면 기준으로
띄우고, 자리는 트리거에서 재서 잡는다. side·align·화면 밖 보정은 같다(카톡테마 메이커 편집 패널의 색 선택기).
