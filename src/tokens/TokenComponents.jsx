...
export function TypographyTable() {
  const rows = [
    ...
    { token: '.text-heading-xs', size: '15px', weight: '600', lh: '1.3', use: '작은 제목. 모달 안 소제목, 카드·목록 항목의 제목, 문서의 작은 절 제목 (예: "늘어나는 곳 정하기", 업데이트 소식 제목). 버튼 글자에는 쓰지 않는다' },
    ...
    { token: '.text-label-md',   size: '15px', weight: '500', lh: '1',   use: '기본 버튼·탭·목록 줄 글자, 토스트. 제목에는 쓰지 않는다(heading-xs)' },
